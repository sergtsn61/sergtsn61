...
export function SectionCard({ title, icon: Icon, iconColor = 'text-accent-primary', children, collapsed, onToggle, action }: SectionCardProps) {
  return (
    <div className="card overflow-hidden">
      <div className="flex items-center px-4 py-3.5 hover:bg-white/[0.02] transition-colors">
        <button onClick={onToggle} className="flex-1 flex items-center gap-2.5 text-left">
